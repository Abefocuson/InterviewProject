...
train_path = "C:\\Users\\admin\\Desktop\\Caugh\\continuous_wavelet_transform\\continuous_wavelet_transform\\train\\"
test_path = "C:\\Users\\admin\\Desktop\\Caugh\\continuous_wavelet_transform\\continuous_wavelet_transform\\validation\\"
...
model_type = 'DenseNet121_Image_Fintune'
...
if not data_augmentation:
    ...
    datagen.fit(IMAGES.data)

    # Fit the model on the batches generated by datagen.flow().
    model.fit_generator(datagen.flow(IMAGES.data, IMAGES.label, batch_size=batch_size),
                        validation_data=(IMAGES_TEST.data, IMAGES_TEST.label),
